...
import ctm.meetingschedueling.util.JsfUtil;
import ctm.meetingschedueling.util.JsfUtil.PersistAction;
...
public class MeetingController implements Serializable {
    ...
    @EJB
    private ctm.meetingschedueling.MeetingFacade ejbFacade;
    ...
    public Meeting getMeeting(java.lang.Short id) {
